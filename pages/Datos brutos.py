...
# Titulo:
st.title("Datos en Bruto")#Luego en venv ejecutar:streamlit run dashboard.py
...
with col2:
   st.download_button('Realiza la descarga de la tabla en formato csv', data=convierte_csv(datos_filtrados),
